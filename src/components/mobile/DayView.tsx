      ...
      if (appointmentId) {
        try {
          ...
          if (updatedAppointment?.status === "confirmed") {
            console.log("PUSH::START::reschedule", { appointment_id: appointmentId });
            await supabase.functions.invoke('notify-appointment-confirmed', {
              body: { appointment_id: appointmentId }
            });
            console.log("PUSH::SUCCESS::reschedule", { appointment_id: appointmentId });
          }
        } catch (err) {
          console.log("PUSH::ERROR::reschedule", { appointment_id: appointmentId, error: err });
