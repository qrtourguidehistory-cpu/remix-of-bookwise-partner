...
export default function SplashPage({ shouldRedirect = true }: { shouldRedirect?: boolean }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {/* Animated background circles - más sutiles en blanco */}
      <motion.div
        className="absolute w-96 h-96 rounded-full bg-black/3"
      ...
      >
        ...
        <motion.p
          className="text-lg md:text-xl text-black/70 mt-6 text-center max-w-md font-medium"
